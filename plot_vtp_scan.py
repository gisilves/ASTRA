...
if __name__ == '__main__':
    ...
    parser.add_argument('--plot', action='store_true', help='Plot the waveforms', default=False, dest='plot')
    ...
    results = functions.process_folder(args.file_path, args.start_waveform, args.stop_waveform,
                                       args.peak_time, args.fit_start_peak, args.fit_end_peak,
                                       args.fit_start_min, args.fit_end_min, args.auto_fit,
                                       args.pt_line, args.note, args.positive_waveforms, args.plot)
